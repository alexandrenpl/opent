...
setBackgroundColgithub.com/fijigithub.com/fijior(mean, mean, mean);
...
// FLAT-FIELD CORRECTION AND BACKGROUND SUBTRACTION ...UNDER CONSTRUCTION! look into Birk et al 2012 polynomial fit 
...
print("Tilt degithub.com/fijiviation: "+difference);
run("Select None");
